...
(function ($) {
    ...
    videoItems.forEach(item => {
        ...
        item.addEventListener('click', () => {
            ...
            modalVideoPlayer.querySelector('source').setAttribute('src', videoSource);
            modalVideoPlayer.load(); // Reload the video element with the new source
            modal.style.display = 'flex'; // Use flex to center the video
    ...
    function closeVideoModal() {
        ...
        modalVideoPlayer.querySelector('source').setAttribute('src', ''); // Clear src
    }
